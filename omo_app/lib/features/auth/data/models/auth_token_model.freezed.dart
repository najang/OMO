...
mixin _$AuthTokenModel {
 ...
 String get accessToken; String get refreshToken; int get userId; bool get isNewUser;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,accessToken,refreshToken,userId,isNewUser);

@override
String toString() {
  return 'AuthTokenModel(accessToken: $accessToken, refreshToken: $refreshToken, userId: $userId, isNewUser: $isNewUser)';
}
...
@useResult
$Res call({
 String accessToken, String refreshToken, int userId, bool isNewUser
});
...
/// Create a copy of AuthTokenModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? accessToken = null,Object? refreshToken = null,Object? userId = null,Object? isNewUser = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  int userId,  bool isNewUser)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthTokenModel() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.isNewUser);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  int userId,  bool isNewUser)  $default,) {final _that = this;
switch (_that) {
case _AuthTokenModel():
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.isNewUser);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  int userId,  bool isNewUser)?  $default,) {final _that = this;
switch (_that) {
case _AuthTokenModel() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.userId,_that.isNewUser);case _:
  return null;
...
class _AuthTokenModel implements AuthTokenModel {
  const _AuthTokenModel({required this.accessToken, required this.refreshToken, required this.userId, required this.isNewUser});
...
/// Create a copy of AuthTokenModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? accessToken = null,Object? refreshToken = null,Object? userId = null,Object? isNewUser = null,}) {
