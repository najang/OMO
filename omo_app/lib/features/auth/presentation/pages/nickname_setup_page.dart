...
import '../../../wardrobe/presentation/pages/wardrobe_setup_page.dart';
import '../../../wardrobe/presentation/widgets/onboarding_widgets.dart';
...
class _NicknameSetupPageState extends ConsumerState<NicknameSetupPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      await ref.read(authNotifierProvider.notifier).setupNickname(_controller.text);
      if (mounted) {
        Navigator.of(context).push(
          MaterialPageRoute<void>(builder: (_) => const WardrobeSetupPage()),
        );
      }
    } catch (e) {
      if (mounted) {
